...
const About = () => {
  ...
  const features = [
    {
      ...
      description: "Carefully curated selection of high-quality items from trusted brands worldwide."
    },
    {
      icon: <FaTruck className="w-8 h-8" />,
      title: "Fast Delivery",
      description: "Lightning-fast shipping with tracking updates to get your orders to you quickly."
    },
    {
      icon: <FaShieldAlt className="w-8 h-8" />,
      title: "Secure Shopping",
      description: "Your data is protected with industry-leading security and encryption technology."
    },
    {
  ...
  const values = [
    {
      ...
      title: "Innovation",
      description: "We continuously evolve our platform to bring you the latest in e-commerce technology and user experience."
    },
    {
    ...
    },
    {
      ...
      description: "Committed to eco-friendly practices and supporting brands that care about our planet&apos;s future."
    },
    {
      icon: <FaHeart className="w-12 h-12" />,
      title: "Community",
      description: "Creating a vibrant community where customers and sellers connect, share, and grow together."
    }
  ];
  ...
  const team = [
    {
      name: "Sarah Johnson",
      role: "CEO & Founder",
      image: "https://images.unsplash.com/photo-1689193502060-4b78d318277e?w=300&h=300&fit=crop&crop=face",
      description: "Visionary leader with 10+ years in e-commerce and digital innovation."
    },
    {
      name: "Michael Chen",
      role: "CTO",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face",
      description: "Tech expert ensuring our platform delivers cutting-edge shopping experiences."
    },
    {
      name: "Emma Davis",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <motion.section 
        className="bg-gradient-to-br from-teal-600 via-teal-700 to-blue-600 text-white py-20"
        initial="hidden"
        animate="visible"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-4 text-gray-600 text-lg leading-relaxed">
                <p>
                  Founded in 2020 with a simple mission: to create the most customer-centric 
                  e-commerce platform in the world. What started as a small team of passionate 
                  entrepreneurs has grown into a thriving marketplace serving customers globally.
                </p>
                <p>
                  We believe that shopping online should be more than just a transaction—it should 
                  be an experience. That&apos;s why we&apos;ve invested heavily in technology, partnerships, 
                  and customer service to ensure every interaction exceeds expectations.
                </p>
                <p>
                  Today, we&apos;re proud to be the trusted choice for thousands of customers worldwide, 
                  offering everything from the latest electronics to fashion, home goods, and beyond.
                </p>
              </div>
            </motion.div>
            <motion.div 
      ...
      {/* CTA Section */}
      <motion.section 
        className="py-20 bg-gradient-to-r from-teal-600 to-blue-600 text-white"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={containerVariants}
      >
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <Link href={'/products'} className="px-8 py-4 bg-white text-teal-600 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105">
              Browse Products
            </Link>
            <Link href={'/'} className="px-8 py-4 border-2 border-white text-white rounded-xl font-semibold hover:bg-white hover:text-teal-600 transition-all duration-300">
              Go To Home
            </Link>
          </motion.div>
        </div>
